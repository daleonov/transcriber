...
def main():
  ...
  plistpath = scriptpath + "/resources/Transcriber-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Transcriber-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Transcriber-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Transcriber-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Transcriber-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Transcriber-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/Transcriber-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/Transcriber.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Transcriber.iss",inplace=1):
